"""Regression checks for the summit-trade-orderbook-mesh casebook."""
...
from casebook.harness import assert_expected, summit_trade_orderbook_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_trade_orderbook_mesh_summary(), assert_expected())
